          ...
          <div className="rounded-lg border border-neutral-800 bg-neutral-900 p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <button
                ...
                className="text-sm px-3 py-1 rounded border border-neutral-600 text-neutral-300 hover:border-white dark:hover:text-white text-neutral-900 transition-colors disabled:opacity-50"
              >
